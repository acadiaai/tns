...
func migrate004PhaseData(db *gorm.DB) error {
	requirements := []PhaseData{
		...
		{ID: "history", PhaseID: "stage_2_information_gathering", Name: "history", Required: true,
			Description: "When issue started",
			Schema: `{"type": "string", "description": "When issue started"}`},
		{ID: "negative_cognition", PhaseID: "stage_2_information_gathering", Name: "negative_cognition", Required: true,
		...
		{ID: "sensation_quality", PhaseID: "stage_3_activating_setup", Name: "sensation_quality", Required: true,
		...
		{ID: "check_in_observations", PhaseID: "stage_5_checking_in", Name: "observations", Required: true,
		...
		{ID: "future_template", PhaseID: "stage_8_expansion", Name: "future_template", Required: true,
		...
		{ID: "session_notes", PhaseID: "completion", Name: "session_notes", Required: true,
