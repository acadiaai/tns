...
CREATE TABLE phase_transitions (
    ...
    rules TEXT, -- JSON data for conditions
...
CREATE INDEX idx_phase_transitions_from ON phase_transitions(from_phase_id);
CREATE INDEX idx_phase_transitions_to ON phase_transitions(to_phase_id);
CREATE INDEX idx_phase_transitions_priority ON phase_transitions(from_phase_id, priority DESC);